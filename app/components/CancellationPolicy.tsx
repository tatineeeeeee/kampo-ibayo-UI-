  ...
  return (
    <div className="space-y-4">
      ...
      <div className="p-4 rounded-lg border bg-blue-50 border-blue-200">
        <h3 className="font-semibold text-blue-800 mb-2">Payment Structure</h3>
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div className="p-2 rounded bg-blue-100">
            <p className="font-medium text-blue-700">Down Payment (Paid)</p>
            <p className="text-lg font-bold text-blue-800">₱{downPayment.toLocaleString()}</p>
          </div>
          <div className="p-2 rounded bg-gray-100">
            <p className="font-medium text-gray-700">Pay on Arrival</p>
            <p className="text-lg font-bold text-gray-800">₱{remainingBalance.toLocaleString()}</p>
          </div>
        </div>
      </div>
        ...
        <div className={`p-4 rounded-lg border ${
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            <div className={`p-2 rounded ${
              ...
              <p className="text-lg">₱{downPayment.toLocaleString()}</p>
            </div>
            <div className={`p-2 rounded ${
              percentage >= 75 ? 'bg-green-100' :
              percentage >= 50 ? 'bg-yellow-100' :
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        ...
        {showPolicy && (
          <div className="mt-3 pt-3 border-t border-gray-200">
            <h4 className="text-sm font-semibold text-gray-700 mb-2">Refund Policy (Down Payment Only):</h4>
            <div className="space-y-2 text-sm text-gray-600">
              <div className="flex justify-between">
                <span>48+ hours before check-in:</span>
                <span className="font-medium text-green-600">100% down payment refund</span>
              </div>
              <div className="flex justify-between">
                <span>24-48 hours before:</span>
                <span className="font-medium text-yellow-600">50% down payment refund</span>
              </div>
              <div className="flex justify-between">
                <span>Less than 24 hours:</span>
                <span className="font-medium text-red-600">No refund - Contact resort</span>
              </div>
            </div>
