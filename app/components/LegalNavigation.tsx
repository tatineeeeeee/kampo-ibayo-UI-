...
import { MessageCircle, Shield, CreditCard, FileText, Phone, ChevronDown, ChevronUp } from "lucide-react";
      ...
      <div className="bg-gray-800/95 backdrop-blur-sm border border-gray-700/50 rounded-xl shadow-xl overflow-hidden">
        ...
        {isExpanded && (
          <div className="py-2">
            <Link
              href="/legal"
              className="flex items-center gap-2 px-4 py-2 text-gray-300 hover:text-white hover:bg-gray-700/50 transition-colors text-sm"
            >
