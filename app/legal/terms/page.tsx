          ...
          <div className="space-y-6 text-gray-300">
            <div>
              ...
              <ul className="space-y-2 list-disc list-inside text-sm leading-relaxed">
                <li>
                  All bookings require a 50% deposit to secure reservation
                </li>
                <li>Remaining balance is due upon check-in</li>
                <li>
                  Bookings are confirmed only after deposit payment and written
                  confirmation
                </li>
                <li>
                ...
                <li>
                  Check-in: 3:00 PM | Check-out: 1:00 PM (strictly enforced)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 list-disc list-inside text-sm leading-relaxed">
                <li>
                  Accepted payment methods: GCash, Maya, or Cash upon arrival
                </li>
                <li>
                  All rates are in Philippine Peso (₱) and inclusive of
                  applicable taxes
                </li>
                <li>
                  Additional charges for damages, excess cleaning, or extra
                  services apply
                </li>
            ...
            <div>
              ...
              <ul className="space-y-2 list-disc list-inside text-sm leading-relaxed">
                <li>
                  Guests must comply with all house rules and local regulations
                </li>
                <li>Responsible for conduct of all members in their party</li>
                <li>
                  Must report any damages or issues immediately to management
                </li>
                <li>
                  Liable for any damages to property, equipment, or facilities
                </li>
            ...
            <div>
              ...
              <ul className="space-y-2 list-disc list-inside text-sm leading-relaxed">
                ...
                <li>
                  Smoking in enclosed areas (designated smoking areas available)
                </li>
                <li>
                  Unauthorized parties or events beyond registered guest count
                </li>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed">
                Kampo Ibayo Resort is not liable for inability to provide
                services due to circumstances beyond our control, including but
                not limited to natural disasters, government regulations,
                pandemics, or infrastructure failures. In such cases, we will
                work with guests to reschedule or provide appropriate
                compensation.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 text-gray-300">
            <div>
              ...
              <ul className="space-y-2 list-disc list-inside text-sm leading-relaxed">
                ...
                <li>
                  <strong>Booking Information:</strong> Dates, guest count,
                  special requests, payment details
                </li>
                <li>
                  <strong>Communication:</strong> Messages, emails, and call
                  records for service improvement
                </li>
                <li>
                  <strong>Property Usage:</strong> Security footage, facility
                  usage logs for safety purposes
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 list-disc list-inside text-sm leading-relaxed">
                ...
                <li>
                  Communicate regarding your stay and provide customer support
                </li>
                <li>
                  Send important updates about policies, safety, or service
                  changes
                </li>
                <li>
                  Improve our services and facilities based on guest feedback
                </li>
            ...
            <div>
              ...
              <ul className="space-y-2 list-disc list-inside text-sm leading-relaxed">
                ...
                <li>
                  With trusted service providers (payment processors, cleaning
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed">
                ...
                disclosure, or destruction. This includes secure data
                transmission, encrypted storage, and limited access to
        ...
        >
          ...
          <div className="space-y-6 text-gray-300">
            <div>
              ...
              <p className="text-sm leading-relaxed mb-3">
                Guests use all facilities at their own risk. Kampo Ibayo Resort
                provides facilities in good condition but is not liable for:
              </p>
              <ul className="space-y-2 list-disc list-inside text-sm leading-relaxed">
                <li>
                  Accidents, injuries, or incidents during recreational
                  activities
                </li>
                <li>Personal property loss, theft, or damage</li>
                <li>Medical emergencies or health issues</li>
                <li>
                  Injuries resulting from failure to follow posted safety
                  guidelines
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 list-disc list-inside text-sm leading-relaxed">
                <li>
                  All equipment and facilities provided &quot;as-is&quot;
                  without warranty
                </li>
                <li>
                  Guests must inspect and report any issues immediately upon
                  arrival
                </li>
                <li>
                  Resort not liable for equipment malfunction or service
                  interruptions
                </li>
                <li>
                  Swimming pool, adventure areas, and all activities are at
                  guest&apos;s own risk
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed">
                The resort is not responsible for transportation to or from the
                property, travel delays, or any incidents that occur outside the
                resort premises. Guests are advised to secure appropriate travel
                insurance.
              </p>
            </div>
          </div>
