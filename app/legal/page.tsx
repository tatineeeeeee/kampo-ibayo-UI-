  ...
  const legalPages = [
    {
      ...
      color: "border-primary/50 bg-primary/10 hover:bg-primary/20",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-background/95 backdrop-blur-sm border-b border-border/50 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-4 py-3 sm:py-4">
          <div className="flex items-center gap-3 sm:gap-4">
            <Link
              href="/"
              className="text-muted-foreground hover:text-foreground transition-colors p-2 rounded-lg hover:bg-muted/50 min-w-[44px] min-h-[44px] flex items-center justify-center touch-manipulation"
            >
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 sm:py-8">
        {/* Introduction */}
        <div className="bg-card/60 backdrop-blur-sm border border-border/50 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-12">
          <div className="bg-card/60 backdrop-blur-sm border border-border/50 rounded-xl p-4 sm:p-6 text-center">
        ...
        {/* Contact Information */}
        <div className="bg-card/60 backdrop-blur-sm border border-border/50 rounded-xl p-4 sm:p-6 mt-6 sm:mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <a
              ...
              className="flex items-center gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors min-h-[56px] touch-manipulation"
            >
