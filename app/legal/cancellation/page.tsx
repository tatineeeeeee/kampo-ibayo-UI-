...
import { ArrowLeft, Calendar, AlertTriangle, Phone, Mail, RefreshCw } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4 py-4 sm:px-6 sm:py-6 space-y-4 sm:space-y-6">
        ...
        <div className="bg-gray-800/95 backdrop-blur-sm rounded-xl shadow-xl p-4 sm:p-6 border border-gray-700/50">
          ...
          <p className="text-gray-300 mb-6 leading-relaxed">
            ...
            With our new down payment system, you only pay 50% upfront when booking, and refunds are calculated based on 
            this down payment amount depending on when you cancel.
          </p>

          <div className="bg-blue-900/20 border border-blue-700/50 rounded-lg p-4 mb-4">
            <h3 className="text-blue-300 font-semibold mb-2">Payment Structure</h3>
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div className="p-2 rounded bg-blue-100/10">
                <p className="font-medium text-blue-200">Down Payment (At Booking)</p>
          ...
          <div className="bg-orange-900/20 border border-orange-700/50 rounded-lg p-4">
            <p className="text-orange-300 text-sm">
              <strong>Important:</strong> Only the down payment (50% of total booking cost) is refundable. 
              Refunds are processed automatically through your bookings page based on cancellation timing. 
              The remaining 50% is paid upon arrival at the resort.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-800/95 backdrop-blur-sm rounded-xl shadow-xl p-4 sm:p-6 border border-gray-700/50">
          ...
          <div className="mt-6 p-4 bg-gray-700/50 rounded-lg">
            <h4 className="font-semibold text-white mb-2">Automatic Refund Processing</h4>
            <ul className="text-gray-300 text-sm space-y-1">
              <li>• <strong>Instant cancellation:</strong> Process refunds immediately through your bookings page</li>
              <li>• <strong>Processing time:</strong> 5-10 business days to original payment method</li>
              <li>• <strong>Refund amount:</strong> Based only on down payment (50% of total booking)</li>
              <li>• <strong>24-hour rule:</strong> No cancellations allowed within 24 hours of check-in</li>
              <li>• <strong>Emergency assistance:</strong> Contact resort directly for special circumstances</li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-gray-800/95 backdrop-blur-sm rounded-xl shadow-xl p-4 sm:p-6 border border-gray-700/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-3 text-white">Online Cancellation (Recommended)</h3>
              <div className="bg-green-900/20 border border-green-700/50 rounded-lg p-4 mb-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-green-300 font-medium">Visit your bookings page</span>
                </div>
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-white text-xs font-bold">2</div>
                  <span className="text-green-300 font-medium">Click &quot;Cancel&quot; on your booking</span>
                </div>
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-white text-xs font-bold">3</div>
                  <span className="text-green-300 font-medium">Review refund amount and policy</span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-green-300 font-medium">Confirm cancellation</span>
                </div>
              </div>
              <p className="text-green-200 text-sm">
                ✅ <strong>Instant processing</strong> - Refunds automatically initiated
              </p>
            </div>

            <div>
              <h3 className="text-lg font-semibold mb-3 text-white">Emergency Contact Methods</h3>
              <p className="text-gray-400 text-sm mb-3">For urgent matters or if you cannot access your account:</p>
          ...
          <div className="mt-6 p-4 bg-blue-900/20 border border-blue-700/50 rounded-lg">
            <h4 className="font-semibold text-blue-400 mb-2">Automatic Processing Benefits</h4>
            <ul className="text-blue-200 text-sm space-y-1">
              <li>• <strong>24/7 availability:</strong> Cancel anytime through your account</li>
              <li>• <strong>Instant confirmation:</strong> Immediate email notification sent</li>
              <li>• <strong>Transparent refunds:</strong> See exact refund amount before confirming</li>
              <li>• <strong>No waiting:</strong> No need to contact staff during business hours</li>
            </ul>
          </div>
        </div>
